<div class="d-flex">
    ...
    <div class="p-2">
        <span class="d-none d-md-block">
            <?= $this->Html->link(__('Listar Usuários'), ['controller' => 'users', 'action' => 'index'], ['class' => 'btn btn-outline-info btn-sm']) ?>

            <?= $this->Html->link(__('Editar Usuários'), ['controller' => 'users', 'action' => 'edit', $user->id], ['class' => 'btn btn-outline-warning btn-sm']) ?>

            <?= $this->Html->link(__('Editar Senha'), ['controller' => 'users', 'action' => 'editSenha', $user->id], ['class' => 'btn btn-outline-dark btn-sm']) ?>
